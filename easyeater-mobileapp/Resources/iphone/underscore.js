(function() {
    function q(a, c, d) {
        ...
        if ("object" != typeof a || "object" != typeof c) return false;
    ...
    var j = b.each = b.forEach = function(a, c, d) {
        if (null != a) if (w && a.forEach === w) a.forEach(c, d); else if (a.length === +a.length) {
            for (var e = 0, f = a.length; f > e; e++) if (e in a && c.call(d, a[e], e, a) === n) break;
    ...
    b.include = b.contains = function(a, c) {
        var b = false;
        if (null == a) return b;
        return p && a.indexOf === p ? -1 != a.indexOf(c) : b = E(a, function(a) {
            return a === c;
        });
    };
    ...
    b.shuffle = function(a) {
        var d, b = [];
        j(a, function(a, f) {
            0 == f ? b[0] = a : (d = Math.floor(Math.random() * (f + 1)), b[f] = b[d], b[d] = a);
        });
        return b;
    };
    ...
    b.first = b.head = function(a, b, d) {
        return null == b || d ? a[0] : i.call(a, 0, b);
    };
    b.initial = function(a, b, d) {
        return i.call(a, 0, a.length - (null == b || d ? 1 : b));
    };
    b.last = function(a, b, d) {
        return null == b || d ? a[a.length - 1] : i.call(a, Math.max(a.length - b, 0));
    };
    b.rest = b.tail = function(a, b, d) {
        return i.call(a, null == b || d ? 1 : b);
    };
    ...
    b.uniq = b.unique = function(a, c, d) {
        ...
        b.reduce(d, function(d, g, h) {
            0 != h && (true === c ? b.last(d) == g : b.include(d, g)) || (d[d.length] = g, e[e.length] = a[h]);
            return d;
        }, []);
        return e;
    };
    ...
    b.zip = function() {
        for (var a = i.call(arguments), c = b.max(b.pluck(a, "length")), d = Array(c), e = 0; c > e; e++) d[e] = b.pluck(a, "" + e);
        return d;
    };
    b.indexOf = function(a, c, d) {
        ...
        for (d = 0, e = a.length; e > d; d++) if (d in a && a[d] === c) return d;
        return -1;
    };
    ...
    b.isBoolean = function(a) {
        return true === a || false === a || "[object Boolean]" == l.call(a);
    };
    b.isDate = function(a) {
    ...
    j("pop,push,reverse,shift,sort,splice,unshift".split(","), function(a) {
        ...
        m.prototype[a] = function() {
            ...
            b.apply(d, arguments);
            var e = d.length;
            ("shift" == a || "splice" == a) && 0 === e && delete d[0];
